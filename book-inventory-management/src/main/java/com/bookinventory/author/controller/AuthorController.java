...
//    public AuthorDTO updateAuthor(@PathVariable Integer authorId,
...
//    public ResponseEntity<Map<String, Object>> getAuthorStats(@PathVariable Integer authorId) {
//
//        return ResponseEntity.ok(authorService.getAuthorStats(authorId));
//    }
//}
